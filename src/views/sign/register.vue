      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <h3 class="title">系统注册</h3>
          ...
          <el-form-item label="确认密码" prop="cfpassword">
            <el-input type="password" v-model="form.cfpassword" placeholder="请确认密码">
            </el-input>
          </el-form-item>

          <el-form-item label="">
            <div>
              <el-button class="w100p" type="primary" @click="register">注册</el-button>
            </div>
            <div class="txt-r">
    ...
    return {
      ...
      rules: {
        ...
        // trigger:  ["blur", "change"], 表单项失去焦点时和在表单项的值改变时都进行验证
          ...
          {pattern: /^[a-zA-Z0-9_-]{3,20}$/, message: '用户名必须是3-20个字母、数字、下划线或减号', trigger: ["blur", "change"]},
        ],
        password: [
